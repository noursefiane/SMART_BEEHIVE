...
void lcd_init(I2C_HandleTypeDef* I2Cx, rgb_lcd* DataStruct)
{
    ...
    /* Default color: white */
    uint8_t data_rgb[2];
    data_rgb[0] = REG_RED;   data_rgb[1] = 255;
    HAL_I2C_Master_Transmit(Handle, (uint16_t)RGB_ADDRESS, (uint8_t *)data_rgb, 2, 1000);

    data_rgb[0] = REG_GREEN; data_rgb[1] = 255;
    HAL_I2C_Master_Transmit(Handle, (uint16_t)RGB_ADDRESS, (uint8_t *)data_rgb, 2, 1000);

    data_rgb[0] = REG_BLUE;  data_rgb[1] = 255;
    HAL_I2C_Master_Transmit(Handle, (uint16_t)RGB_ADDRESS, (uint8_t *)data_rgb, 2, 1000);
}
...
void set_color(uint8_t R, uint8_t G, uint8_t B)
{
    ...
    HAL_I2C_Master_Transmit(Handle, (uint16_t)RGB_ADDRESS, (uint8_t *)data, 2, 1000);
